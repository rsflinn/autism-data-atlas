...
* Do the proband-WGS noncoding variants overlap HDMA fetal-brain cCREs at higher rate than expected from a matched random-variant sample?
...
Candidate. Saved metadata to `raw/tools/HDMA.json`. Repo and Zenodo content not yet downloaded or run against the proband WGS.
